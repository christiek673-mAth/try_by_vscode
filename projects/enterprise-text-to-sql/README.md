...
[![CI](https://github.com/christiek673-mAth/try_by_vscode/actions/workflows/enterprise-text-to-sql.yml/badge.svg)](https://github.com/christiek673-mAth/try_by_vscode/actions/workflows/enterprise-text-to-sql.yml)
...
> 本项目位于 Monorepo 的 `projects/enterprise-text-to-sql/` 目录。历史独立版本 `v0.3.0` 已整理到仓库根目录的 `archives/enterprise-text-to-sql-v0.3.0/`，其中的说明文档位于其 `docs/` 目录。
...
cd try_by_vscode/projects/enterprise-text-to-sql
